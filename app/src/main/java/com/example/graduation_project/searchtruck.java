...
public class searchtruck extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_searchtruck);
        getCurrentLocation();
    ...
    private void fillspinner() {
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.POST, url,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(searchtruck.this, error.toString(),
    ...
    private void getcity() {
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.POST, url,
            ...
            public void onResponse(JSONArray response) {
                ...
                ArrayAdapter<String> adapter= new ArrayAdapter<>(searchtruck.this , android.R.layout.simple_spinner_item,city);
    ...
    private void getmecname() {
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.POST, url,
            ...
            public void onResponse(JSONArray response) {
                ...
                ArrayAdapter<String> adapter= new ArrayAdapter<>(searchtruck.this , android.R.layout.simple_spinner_item,mecname3);
                spinner2.setAdapter(adapter);

                adapter2 = new ArrayAdapter<String>(searchtruck.this,android.R.layout.select_dialog_item, mecname3);
    ...
    private void getCurrentLocation () {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (ActivityCompat.checkSelfPermission(searchtruck.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {

                if (isGPSEnabled()) {

                    LocationServices.getFusedLocationProviderClient(searchtruck.this)
        ...
        result.addOnCompleteListener(new OnCompleteListener<LocationSettingsResponse>() {
            ...
            public void onComplete(@NonNull Task<LocationSettingsResponse> task) {
                ...
                try {
                    ...
                    Toast.makeText(searchtruck.this, "GPS is already tured on", Toast.LENGTH_SHORT).show();
                    ...
                    switch (e.getStatusCode()) {
                        case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                            ...
                            try {
                                ...
                                resolvableApiException.startResolutionForResult(searchtruck.this, 2);
